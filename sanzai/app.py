...
from sanzai.blueprints.contact import contact

from sanzai.extensions import debug_toolbar, mail, csrf


CELERY_TASK_LIST = [
    'sanzai.blueprints.contact.tasks',
]
...
def create_app(settings_override=None):
    ...
    app.register_blueprint(contact, url_prefix='/holboo')
